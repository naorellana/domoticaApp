...
<div class="card-group">
    <div class="card text-center">
        ...
        <div class="card-body">
            <h2 class="card-title">Temperatura <span class="badge badge-danger">25 &degC</span></h2>
    ...
    <div class="card text-center">
        ...
        <div class="card-body">
            <h2 class="card-title">Humedad <span class="badge badge-primary">25 %</span></h2>
    ...
    <div class="card text-center">
        ...
        <div class="card-body">
            <h2 class="card-title">Presión Atmosférica<span class="badge badge-secondary">1021 hPa</span></h2>
