...
<div class="card-group">
    <div class="card text-center">
        <img width="200" height="200" class="card-img-top" src="https://image.flaticon.com/icons/svg/543/543980.svg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="card text-center">
        <img class="card-img-top" width="200px" height="200px" src="https://image.flaticon.com/icons/svg/543/543987.svg"  alt="Card image cap">
        <div class="card-body">
